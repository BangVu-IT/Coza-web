        ...
        <div>
            ...
            <div className="san-pham-mua">
                ...
                <div className="so-luong item-sp">
                    <button onClick={() => props.onReduction(props.cart.cart_id)}><i className="fas fa-minus"></i></button>
                    <button className="btn-hien-thi-so-luong">{props.cart.quantity}</button>
                    <button onClick={() => props.onIncrease(props.cart.cart_id)}><i className="fas fa-plus"></i></button>
                </div>
                <div onClick={() => props.onRemove(props.cart.cart_id)} className="thao-tac item-sp">
